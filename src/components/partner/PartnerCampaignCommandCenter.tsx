...
const COPY = {
  ...
  es: {
    ...
    refresh: 'Actualizar',
    emptyTitle: 'Aún no hay campanas aprobadas',
    emptyDescription: 'Cuando Baise te apruebe para una campana, veras aquí tu enlace, QR, conversiones, pagos y recibos.',
    ...
    noPayouts: 'Aún no hay pagos registrados.',
    noReceipts: 'Aún no hay recibos generados.',
    campaign: 'Campana',
    ...
    loadError: 'Los datos del portal de socios aún no están disponibles.',
    noDate: 'Aún no',
    ...
    applicationReview: 'Revisión antes de',
    completeApplication: 'Completar solicitud',
  },
  pt: {
    eyebrow: 'Portal de parceiros',
    title: 'Suas campanhas, clientes e pagamentos',
    description: 'Uma visao simples das pessoas que você trouxe, dos clientes convertidos e do dinheiro pago ou pronto para você.',
    refresh: 'Atualizar',
    emptyTitle: 'Ainda não ha campanhas aprovadas',
    emptyDescription: 'Quando a Baise aprovar você para uma campanha, seu link, QR code, conversoes, pagamentos e recibos aparecerao aqui.',
    ...
    stats: {
      ...
      monthly: 'Este mês',
      monthlyDetail: 'Ganhos de parceiro aprovados no mês atual.',
      lifetime: 'Ganhos totais',
      lifetimeDetail: 'Total creditado a sua conta de parceiro.',
    },
    campaignsTitle: 'Minhas campanhas',
    campaignsDescription: 'Campanhas aprovadas que você pode compartilhar agora.',
    ...
    payoutDescription: 'O que você recebeu, quando recebeu e o recibo de cada pagamento.',
    ...
    noPayouts: 'Ainda não ha pagamentos registrados.',
    noReceipts: 'Ainda não ha recibos gerados.',
    campaign: 'Campanha',
    ...
    saveError: 'Não foi possível salvar o identificador',
    receiptCreated: 'Recibo gerado',
    receiptError: 'Não foi possível gerar o recibo',
    loadError: 'Os dados do portal de parceiros ainda não estao disponiveis.',
    noDate: 'Ainda não',
    applicationsTitle: 'Status da inscricao',
    applicationsDescription: 'Inscrições feitas nas paginas de parceiros e influenciadores ficam conectadas a este portal.',
    applicationReview: 'Revisao até',
