  ...
  const shareOptions = [
    {
      ...
      action: () => window.open(`https://wa.me/?text=${encodeURIComponent(fullShareText)}`, '_blank', 'noopener,noreferrer'),
    },
    {
      name: 'Telegram',
      icon: (
      ...
      action: () => window.open(`https://t.me/share/url?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(shareMessage)}`, '_blank', 'noopener,noreferrer'),
    },
    {
      name: 'Facebook',
      icon: (
    ...
    },
    {
      ...
      action: () => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareMessage)}&url=${encodeURIComponent(shareUrl)}`, '_blank', 'noopener,noreferrer'),
    },
    {
      name: 'SMS',
