...
const OPERATIONS_COPY = {
  ...
  es: {
    ...
    refresh: 'Actualizar',
    empty: 'Aún no hay registros operativos para esta vista.',
    metadata: 'Detalles',
    actor: 'Actor',
    resource: 'Registro',
  ...
  pt: {
    ...
    description: 'Acompanhe planos de pagamento, faturas, integrações, mensagens e ações do cliente em um único registro do prestador.',
    total: 'Registros',
    warnings: 'Alertas',
    critical: 'Criticos',
    ...
    export: 'Baixar CSV',
    refresh: 'Atualizar',
    empty: 'Ainda não ha registros operacionais para esta visualização.',
    metadata: 'Detalhes',
    actor: 'Ator',
    resource: 'Registro',
    loadError: 'Não foi possível carregar as operações do prestador.',
    recordsError: 'Não foi possível carregar os registros operacionais.',
