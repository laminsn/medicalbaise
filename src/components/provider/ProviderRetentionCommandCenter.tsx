...
const RETENTION_COPY = {
  ...
  es: {
    ...
    requiredDescription: 'Crea una cuenta de proveedor para gestionar seguimientos, recuperación de cotizaciones, reseñas y reactivación.',
    title: 'Panel de ingresos de clientes',
    description: 'Leads, seguimientos, cotizaciones, reseñas y reactivaciones que convierten el historial en trabajo repetido.',
    refresh: 'Actualizar',
    ...
    reviewReady: 'Proyectos listos para reseña',
    ...
    latestCampaignsDescription: 'Mensajes recientes para seguimientos, reseñas, pagos y trabajo repetido.',
    emptyActions: 'No hay acciones urgentes de ingresos ahora.',
    emptyCampaigns: 'Aún no hay campanas de clientes.',
    createCampaign: 'Crear campana',
    creating: 'Creando',
    followUpLabel: 'Seguimiento',
    quoteLabel: 'Cotización',
    reviewLabel: 'Reseña',
    winbackLabel: 'Reactivación',
    paymentLabel: 'Pago',
    followUpSubject: 'Seguimiento de tu servicio',
    followUpMessage: 'Estamos dando seguimiento desde Baise. Tus notas, archivos, pagos y proximos pasos están listos en el portal.',
    quoteSubject: 'Tu cotización esta lista',
    quoteMessage: 'Tu cotización esta lista en Baise. Revisa alcance, precio, fecha y escribenos en el portal si tienes preguntas.',
    reviewSubject: 'Comparte una reseña verificada',
    reviewMessage: 'Gracias por confiar en nosotros. Deja una reseña verificada en Baise para ayudar a futuros clientes.',
    winbackSubject: 'Listo para tu próximo servicio',
    winbackMessage: 'Tu historial, recibos y proximas opciones de reserva están listos dentro de Baise cuando los necesites.',
    paymentSubject: 'Registro de pago esperando en Baise',
    paymentMessage: 'Tus detalles de pago, factura, recibos e historial del servicio están listos en tu portal Baise.',
  ...
  pt: {
    ...
    requiredDescription: 'Crie uma conta de prestador para gerenciar acompanhamentos, recuperação de orçamentos, avaliações e reativação.',
    title: 'Painel de receita de clientes',
    description: 'Leads, acompanhamentos, orçamentos, avaliações e reativações que transformam histórico em trabalho recorrente.',
    refresh: 'Atualizar',
    ...
    signalsDescription: 'Saude do pipeline, orçamentos, projetos e relacionamentos em uma vista.',
    openQuotes: 'Orçamentos abertos',
    staleQuotes: 'Orçamentos para seguir',
    activeProjects: 'Projetos ativos',
    reviewReady: 'Projetos prontos para avaliação',
    winbackReady: 'Clientes para reativar',
    actionsTitle: 'Ações de clientes',
    actionsDescription: 'Crie mensagens portal primeiro para manter clientes, recibos, aprovações e decisoes dentro do Baise.',
    latestCampaigns: 'Campanhas recentes',
    latestCampaignsDescription: 'Mensagens recentes para acompanhamentos, avaliações, pagamentos e trabalho recorrente.',
    emptyActions: 'Não ha ações urgentes de receita agora.',
    emptyCampaigns: 'Ainda não ha campanhas de clientes.',
    createCampaign: 'Criar campanha',
    creating: 'Criando',
    followUpLabel: 'Acompanhamento',
    quoteLabel: 'Orçamento',
    reviewLabel: 'Avaliação',
    winbackLabel: 'Reativação',
    paymentLabel: 'Pagamento',
    followUpSubject: 'Acompanhamento do seu serviço',
    followUpMessage: 'Estamos acompanhando pelo Baise. Suas notas, arquivos, pagamentos e proximos passos estao prontos no portal.',
    quoteSubject: 'Seu orçamento esta pronto',
    quoteMessage: 'Seu orçamento esta pronto no Baise. Revise escopo, preco, prazo e fale conosco no portal se tiver dúvidas.',
    reviewSubject: 'Compartilhe uma avaliação verificada',
    reviewMessage: 'Obrigado por confiar em nos. Deixe uma avaliação verificada no Baise para ajudar futuros clientes.',
    winbackSubject: 'Pronto para seu próximo serviço',
    winbackMessage: 'Seu histórico, recibos e proximas opções de reserva estao prontos dentro do Baise quando precisar.',
    paymentSubject: 'Registro de pagamento esperando no Baise',
    paymentMessage: 'Seus detalhes de pagamento, fatura, recibos e histórico do serviço estao prontos no portal Baise.',
    loadError: 'Não foi possível carregar o painel de receita.',
    recordsError: 'Não foi possível carregar os registros de clientes.',
