...
const FINANCE_COPY = {
  ...
  es: {
    ...
    actionTitle: 'Dinero que necesita atencion',
    ...
    upcomingDescription: 'Pagos recurrentes, divididos, de suscripcion y por hitos que vencen pronto.',
    exportTitle: 'Registros listos para exportar',
    exportDescription: 'Facturas y transacciones formateadas para impuestos, recibos, contabilidad y revision financiera.',
  ...
  pt: {
    ...
    requiredDescription: 'Crie uma conta de prestador para gerenciar saldos, faturas, tentativas de pagamento, reembolsos, creditos e exportacoes.',
    ...
    actionDescription: 'Pagamentos falhos, faturas vencidas, faturas nao enviadas, reembolsos, creditos e acoes do cliente.',
    upcomingTitle: 'Pagamentos programados proximos',
    upcomingDescription: 'Pagamentos recorrentes, divididos, de assinatura e por marcos com vencimento proximo.',
    exportTitle: 'Registros prontos para exportar',
    exportDescription: 'Faturas e transacoes formatadas para impostos, recibos, contabilidade e revisao financeira.',
    emptyActions: 'Nao ha acoes financeiras urgentes agora.',
    emptyUpcoming: 'Nao ha pagamentos programados nesta visualizacao.',
    loadError: 'Nao foi possivel carregar o espaco financeiro do prestador.',
    recordsError: 'Nao foi possivel carregar os registros financeiros.',
    updateError: 'Nao foi possivel atualizar o registro financeiro.',
    updated: 'Registro financeiro atualizado.',
    exported: 'CSV financeiro baixado.',
    noExport: 'Nao ha registros financeiros para exportar.',
    markSent: 'Marcar enviada',
    openCheckout: 'Abrir checkout',
    due: 'Vence',
    issued: 'Emitida',
