...
const INTEGRATION_COPY = {
  en: {
    ...
    apiKeyDescription: 'Generate provider-scoped keys for approved AI assistants and automation tools. Full keys are shown once. The agent API is not live yet — a key you generate now will not be accepted until it ships.',
    keyName: 'Key name',
  ...
  es: {
    catalog: {
      ...
      google_drive: 'Adjunta propuestas, archivos de trabajo, recibos, fotos antes/después y documentos del cliente.',
      ...
      anthropic_claude: 'Apoya planificación larga, revisión de documentos, manuales del proveedor y borradores de comunicación.',
    ...
    modelDescription: 'Estas integraciones están centradas intencionalmente en el portal.',
    ...
    serverDescription: 'El portal guarda estado y configuración, no secretos API en el navegador.',
    ...
    apiKeyDescription: 'Genera claves del proveedor para asistentes de IA y automatizaciones aprobadas. La clave completa se muestra una sola vez. La API de agentes aún no está activa: una clave que genere ahora no será aceptada hasta que se lance.',
    ...
    noKeys: 'Aún no hay claves API de IA.',
  },
  pt: {
    catalog: {
      gmail: 'Envie confirmações, recibos, acompanhamentos e respostas de suporte pelo Gmail conectado.',
      google_calendar: 'Sincronize reservas, cancelamentos, acompanhamentos, campanhas, inspeções e vencimentos de pagamento.',
      google_drive: 'Anexe propostas, arquivos de trabalho, recibos, fotos antes/depois e documentos do cliente.',
      microsoft_office: 'Conecte Outlook, calendário, OneDrive, planilhas e fluxos de documentos.',
      openai_chatgpt: 'Gere rascunhos de campanhas, resumos de serviços, SOPs, respostas, conteúdo e ferramentas internas de IA.',
      anthropic_claude: 'Apoie planejamento longo, revisao de documentos, manuais do prestador e rascunhos de comunicação.',
      quickbooks: 'Sincronize faturas, clientes, pagamentos, reembolsos, creditos, custos de subcontratados e registros fiscais.',
      plaid: 'Verifique contas bancarias, reconcilie repasses e melhore a visibilidade das transações.',
      whatsapp_business: 'Envie lembretes e campanhas de apoio mantendo o portal como fonte principal.',
      postiz: 'Agende e sincronize conteúdo social do prestador nos canais conectados do Postiz mantendo campanhas ligadas ao Baise.',
    ...
    title: 'Central de integrações API',
    ...
    beforeSync: 'antes da sincronização ativa.',
    registered: 'registrado',
    disabled: 'desativado',
    manageError: 'Não foi possível gerenciar',
    loadError: 'Não foi possível carregar as integrações do prestador.',
    recordsError: 'Não foi possível carregar as integrações.',
    modelTitle: 'Modelo operacional das integrações',
    modelDescription: 'Estas integrações sao intencionalmente centradas no portal.',
    ...
    serverDescription: 'O portal guarda status e configuração, não segredos de API no navegador.',
    recordsTitle: 'Campanhas ficam ligadas aos registros',
    recordsDescription: 'Mensagens, faturas, recibos e calendário permanecem conectados para prova e impostos.',
    apiKeyTitle: 'Chaves API de IA',
    apiKeyDescription: 'Gere chaves do prestador para assistentes de IA e automações aprovadas. A chave completa aparece uma unica vez. A API de agentes ainda não está ativa — uma chave gerada agora não será aceita até o lançamento.',
    keyName: 'Nome da chave',
    createKey: 'Gerar chave',
    revokeKey: 'Revogar',
    oneTimeKey: 'Copie esta chave agora. Ela não será exibida novamente.',
    copyKey: 'Copiar chave',
    copied: 'Copiado.',
    keyCreated: 'Chave API gerada.',
    keyRevoked: 'Chave API revogada.',
    keyError: 'Não foi possível gerenciar chaves API.',
    noKeys: 'Ainda não ha chaves API de IA.',
  },
} as const;
