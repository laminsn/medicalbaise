...
const CALENDAR_COPY = {
  ...
  es: {
    ...
    create: 'Crear evento y notificación',
    ...
    titleRequired: 'Agrega un título claro para el evento.',
    ...
    created: 'Evento de calendario y notificación del portal creados.',
  ...
  pt: {
    ...
    requiredTitle: 'Gerenciador de calendário do prestador',
    ...
    addDescription: 'Mantenha reservas, cancelamentos, acompanhamentos, lembretes de pagamento, inspeções, notificações e campanhas em um calendário do prestador.',
    title: 'Título',
    ...
    create: 'Criar evento e notificação',
    queue: 'Fila do calendário',
    queueDescription: 'Reservas, cancelamentos, acompanhamentos, notificações programadas, lembretes de pagamento e campanhas.',
    allTypes: 'Todos os tipos',
    empty: 'Não ha eventos de calendário nesta visualização.',
    portalFirst: 'Portal primeiro',
    noNotes: 'Sem notas',
    done: 'Concluir',
    cancel: 'Cancelar',
    loadError: 'Não foi possível carregar o calendário do prestador.',
    recordsError: 'Não foi possível carregar os eventos do calendário.',
    titleRequired: 'Adicione um título claro para o evento.',
    strategy: 'O portal e principal. Email e WhatsApp sao canais de apoio para lembretes e confirmações.',
    defaultMessage: 'esta agendado no seu portal Baise.',
    created: 'Evento de calendário e notificação do portal criados.',
    updateError: 'Não foi possível atualizar o evento.',
    updated: 'Evento de calendário atualizado.',
