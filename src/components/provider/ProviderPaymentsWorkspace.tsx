...
const PAYMENT_COPY = {
  ...
  es: {
    ...
    activePlansDescription: 'Planes recurrentes, divididos, de suscripción o por hitos.',
    builderTitle: 'Creador de planes de pago flexibles',
    builderDescription: 'Crea pagos unicos, recurrentes, de suscripción, divididos o por hitos vinculados a facturas, recordatorios y fechas del calendario.',
    ...
    manual: 'Manual',
    benchmark: 'Hito',
    benchmarkPlaceholder: 'Inspección aprobada',
    ...
    noPlans: 'Aún no hay planes de pago flexibles.',
    ...
    validAmount: 'Ingresa un total válido.',
    titleRequired: 'Agrega un título para el plan de pago.',
    ...
    noExport: 'Ninguna transacción coincide con este filtro de exportación.',
  },
  pt: {
    planTypes: {
    ...
    providerRequiredDescription: 'Crie uma conta de prestador para gerenciar POS, faturas, planos de pagamento e exportações.',
    paidRevenue: 'Receita paga',
    paidRevenueDescription: 'Faturas marcadas como pagas no período selecionado.',
    ...
    builderDescription: 'Crie pagamentos unicos, recorrentes, de assinatura, divididos ou por marcos vinculados a faturas, lembretes e datas no calendário.',
    planTitle: 'Título do plano',
    planTitlePlaceholder: 'Serviço mensal de limpeza',
    clientName: 'Nome do cliente',
    clientNamePlaceholder: 'Cliente ou empresa',
    clientEmail: 'Email do cliente',
    startDate: 'Data de inicio',
    serviceDescription: 'Descrição do serviço',
    servicePlaceholder: 'Escopo, entregas, pontos de inspecao ou detalhes do serviço recorrente',
    ...
    createPlan: 'Criar plano, fatura, calendário e lembretes',
    historyTitle: 'Histórico de transações e exportações',
    historyDescription: 'Filtre recibos, faturas, creditos, reembolsos, pagamentos POS e liberações de subcontratados para registros fiscais.',
    exportCsv: 'Exportar CSV',
    ...
    credited: 'Creditado',
    cancelled: 'Cancelado',
    noTransactions: 'Nenhuma transação corresponde a este filtro.',
    activePlansTitle: 'Planos flexiveis ativos',
    activePlansDescriptionLong: 'Os cronogramas de pagamento ficam conectados a faturas, vencimentos no calendário e lembretes do portal.',
    noPlans: 'Ainda não ha planos de pagamento flexiveis.',
    ...
    checkoutError: 'Não foi possível criar checkout para este pagamento programado.',
    retryDue: 'Nova tentativa pendente',
    noClientId: 'Sem ID do cliente',
    validAmount: 'Informe um total válido.',
    titleRequired: 'Adicione um título para o plano de pagamento.',
    loadError: 'Não foi possível carregar a area de pagamentos do prestador.',
    recordsError: 'Não foi possível carregar os registros de pagamento.',
    created: 'Plano de pagamento criado para a fatura',
    createError: 'Não foi possível criar o plano de pagamento.',
    noExport: 'Nenhuma transação corresponde a este filtro de exportação.',
  },
} as const;
