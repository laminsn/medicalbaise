...
const COPY = {
  ...
  es: {
    requiredTitle: 'Sistema de activacion de clientes',
    requiredDescription: 'Crea una cuenta de proveedor para gestionar acceso, conversion, pasos requeridos, documentos, campanas y QA.',
    title: 'Sistema de activacion de clientes',
    ...
    refresh: 'Actualizar',
    contact: 'Contacto',
    noContacts: 'Aun no hay contactos CRM. Crea un contacto primero.',
  ...
  pt: {
    ...
    refresh: 'Atualizar',
    contact: 'Contato',
    noContacts: 'Ainda nao ha contatos CRM. Crie um contato primeiro.',
    ...
    gateType: 'Tipo',
    gateStatus: 'Status',
    requiredAction: 'Acao obrigatoria',
