...
const WORKFLOW_COPY = {
  ...
  es: {
    ...
    description: 'Calendario, pagos, mensajes y alertas que necesitan atención del proveedor.',
    refresh: 'Actualizar',
    schedule: 'Agenda',
    payments: 'Pagos',
    messages: 'Mensajes',
    ...
    calendarAction: 'Acción de agenda',
  ...
  pt: {
    ...
    description: 'Calendário, pagamentos, mensagens e alertas que precisam de atencao do prestador.',
    refresh: 'Atualizar',
    schedule: 'Agenda',
    payments: 'Pagamentos',
    messages: 'Mensagens',
    ...
    upcomingTitle: 'Agenda próxima',
    upcomingDescription: 'Serviços, acompanhamentos, inspeções e lembretes.',
    allClear: 'Não ha itens urgentes agora.',
    noSchedule: 'Não ha eventos proximos nesta visualização.',
    loadError: 'Não foi possível carregar o registro do prestador.',
    recordsError: 'Não foi possível carregar a fila operacional.',
    calendarAction: 'Ação de agenda',
    paymentAction: 'Ação de pagamento',
