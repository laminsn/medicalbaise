...
const MESSAGING_COPY = {
  ...
  es: {
    templates: {
      booking_confirmation: {
        ...
        purpose: 'Confirma fecha, alcance, ubicacion, hilo del portal y expectativas de pago.',
      ...
      cancellation: {
        title: 'Actualizacion de cancelacion',
      ...
      follow_up: {
        title: 'Seguimiento',
        purpose: 'Trae al cliente de vuelta al portal despues de completar el servicio o enviar una cotizacion.',
      ...
      review_request: {
        ...
        purpose: 'Pide una resena verificada ligada al historial real del servicio.',
        body: 'Gracias por usar nuestro servicio. Deja una resena verificada en Baise para que futuros clientes reserven con confianza.',
      },
      coupon: {
      ...
      winback: {
        title: 'Reactivacion',
        purpose: 'Reactiva clientes inactivos sin mover la relacion fuera de Baise.',
        body: 'Ha pasado tiempo desde tu ultimo servicio. Tu historial, recibos y proximas opciones de reserva estan listos dentro de Baise.',
      },
    },
    ...
    name: 'Nombre',
    namePlaceholder: 'Confirmacion de reserva',
    type: 'Tipo',
    audience: 'Audiencia',
  ...
  pt: {
    templates: {
      booking_confirmation: {
        title: 'Confirmacao de reserva',
        purpose: 'Confirma data, escopo, local, conversa no portal e expectativas de pagamento.',
        body: 'Sua reserva esta confirmada. Mantenha mensagens, arquivos, atualizacoes e pagamentos dentro do portal Baise para tudo ficar organizado.',
      },
      booking_reminder: {
        title: 'Lembrete de reserva',
        purpose: 'Envia lembretes de 24 horas e 2 horas com instrucoes centradas no portal.',
        body: 'Lembrete: seu servico sera realizado em breve. Abra o portal Baise para ver horarios, notas, arquivos e atualizacoes do prestador.',
      },
      cancellation: {
        title: 'Atualizacao de cancelamento',
        purpose: 'Gerencia trabalhos cancelados ou reagendados sem perder o registro do cliente.',
        body: 'Este servico foi cancelado ou precisa ser reagendado. Use o portal Baise para escolher o proximo passo e manter o registro completo.',
      },
      follow_up: {
        title: 'Acompanhamento',
        purpose: 'Traz o cliente de volta ao portal apos a conclusao ou envio de orcamento.',
        body: 'Estamos acompanhando seu servico. Voce pode revisar notas, recibos, proximos passos e falar conosco dentro do Baise.',
      },
      payment_reminder: {
        title: 'Lembrete de pagamento',
        purpose: 'Lembra clientes sobre pagamentos unicos, recorrentes, divididos ou por marcos.',
        body: 'Seu pagamento esta pronto no portal Baise. Voce pode ver a fatura, historico de recibos e calendario de pagamento antes de pagar.',
      },
      review_request: {
        title: 'Pedido de avaliacao',
        purpose: 'Pede uma avaliacao verificada ligada ao historico real do servico.',
        body: 'Obrigado por usar nosso servico. Deixe uma avaliacao verificada no Baise para que futuros clientes possam reservar com confianca.',
      },
      coupon: {
        title: 'Cupom ou oferta',
        purpose: 'Transforma clientes antigos e leads aquecidos em novas reservas.',
        body: 'Uma nova oferta esta disponivel no seu portal Baise. Abra o portal para ver detalhes, reservar e manter seu historico de recibos.',
      },
      winback: {
        title: 'Reativacao',
        purpose: 'Reativa clientes inativos sem levar a relacao para fora do Baise.',
        body: 'Faz tempo desde seu ultimo servico. Seu historico, recibos e proximas opcoes de reserva estao prontos no Baise.',
      },
    },
    ...
    name: 'Nome',
    namePlaceholder: 'Confirmacao de reserva',
    type: 'Tipo',
    audience: 'Publico',
    primaryChannel: 'Canal principal',
    clients: 'Clientes',
    ...
    recordsError: 'Nao foi possivel carregar as campanhas.',
